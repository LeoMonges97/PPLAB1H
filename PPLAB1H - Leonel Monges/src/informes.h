...
#define INFORMES_H_
	...
	//int inf_retornarMaxOrMinDeAvisosPorRubro(Aviso* pArray, int limite, Rubro* pArrayRubros, int limiteRubros, int opcionMaxOrMin);
	//int inf_calcularRubroConMaxOrMinAvisos(Aviso* pArray, int limite, Rubro* pArrayRubros, int limiteRubros, int opcionMaxOrMin);
	...
	//int inf_calcularRubroConMaxOrMinAvisos(Aviso* pArray, int limite, int opcionMaxOrMin, Rubro* pArrayRubros, int limiteRubros);
