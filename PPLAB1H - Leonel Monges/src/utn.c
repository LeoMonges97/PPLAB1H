...
int utn_getOpcionesTipoChar(char* mensaje,char* mensajeError,char* pResultado,int reintentos,char rangoInicial,char rangoFinal)
{
	...
	//char auxRangoInicialMAyus = toupper(rangoInicial);
	//char auxRangoFinalMayus = toupper(rangoFinal);
	//((bufferChar >= auxRangoInicialMAyus) && (bufferChar <= auxRangoFinalMayus))
 ...
 * @return   (0) OK / (-1) Error
 */
int utn_getRespuesta(char* pregunta, char* pRespuesta)
{
	int retorno = -1;
	char bufferChar;
